...
const BASE_SYSTEM_PROMPT = `You are Rara, a helpful and intelligent AI assistant. You provide clear, accurate, and concise responses to user queries.
...
const AGENTIC_SYSTEM_PROMPT = `${BASE_SYSTEM_PROMPT}
...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt =
      mode === "agentic" ? AGENTIC_SYSTEM_PROMPT : BASE_SYSTEM_PROMPT;
