...
export interface SearchConfig {
  ...
  /** Function to generate URL from hit object (optional, overrides attributes.url) */
  urlGenerator?: (hit: any) => string | undefined;
...
export function SearchModal({ onClose, config }: SearchModalProps) {
  ...
  const showResultsPanel = !noResults && !!query && !hasError;
